$(document).ready(function() {
    ...
    playlistView.css('max-height', ($('body').height() - 25 - playlistView.position().top - parseInt(playlistView.css('padding-top').replace('px', ''))) + 'px');
    ...
    function updateData(data, completion) {
        tracks = new Array();
        tweets = new Array();
